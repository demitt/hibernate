...
INSERT INTO AUCTION_CLIENT (LOGIN, NAME, LAST_NAME, DELIVERY_ADDRESS, CONTACT_PHONE) VALUES ('Лютый_Бандеровец', 'Дмитрий', null, 'Украина, Крым, мыс Айя', '380971208899');

INSERT INTO LOT (ITEM_ID, OWNER_ID, START_PRICE, CURRENT_PRICE) VALUES (1, 1, 9.99, 9.99);
